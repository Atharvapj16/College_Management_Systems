...
SECRET_KEY = 'f2zx8*lb*em*-*b+!&1lpp&$_9q9kmkar+l3x90do@s(+sr&x7'  # Consider using a secure method to manage this
...
DATABASES = {
    ...
    # Uncomment and configure the following for MySQL if needed
    # 'default': {
...
EMAIL_PORT = 587
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')  # Get email from environment variable
...
# Update database settings for production if using dj_database_url
